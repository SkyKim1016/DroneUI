...
.service("activeXLive", function(){
        ...
        {	// [ XNS ACTIVEX HELP ]
            ...
            // to the device.
            // -----------------------------------------------------------------------
            XnsSdkDevice.SetConnectionInfo(hDevice, "Samsung", info.Model, 1, info.IpAddress, info.Port, 0, info.ID, info.PW);        
...
//                        return;
        ...
        var do_connect = Do_Connect;
        var activex_onload = function(){
            console.log('in activex onload ~~~~~~~~~~~~');
            window_onload();
            Do_Connect();
            setTimeout(function(){
                Do_MediaOpen();
        ...
        var open_media = Do_MediaOpen;
        var play_media = Do_PlayVideo;
        var switchChannel = function(index){
            Do_StopVideo();
            Do_PlayVideo(channelid);      
        }
        
        
        return {
            activex_onload:activex_onload   
        };
